...
```{r}
# Get all columns related to pharmacy transactions 

mingo_pharmacy <- select(mingo, BUYER_NAME, BUYER_ADDRESS1, BUYER_CITY, BUYER_STATE, BUYER_ZIP, BUYER_COUNTY, DOSAGE_UNIT)
...
mingo_pharmacy <- mingo %>% 
  select(BUYER_NAME, BUYER_ADDRESS1, BUYER_CITY, BUYER_COUNTY, BUYER_STATE, BUYER_ZIP, DOSAGE_UNIT)%>%arrange(desc(DOSAGE_UNIT))
